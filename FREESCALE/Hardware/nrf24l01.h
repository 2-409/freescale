...
#define WR_TX_PLOAD     0xA0  //?TX????,1~32??  xiangdangyu WRITE_REG_NRF +TX_ADDR
...
#define _STATUS          0x07  //?????;bit0:TX FIFO???;bit3:1,???????(??:6);bit4,???????
//bit5:????????;bit6:??????;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01???
#define NRF24L01_CE   PGout(6) //24L01????
#define NRF24L01_CSN  PGout(7) //SPI????	   
#define NRF24L01_IRQ  PGin(8)  //IRQ??????

#define TX_ADR_WIDTH    5   	//5???????
#define RX_ADR_WIDTH    5   	//5???????
#define TX_PLOAD_WIDTH  3 	//32?????????
#define RX_PLOAD_WIDTH  3  	//32?????????
									   	   

void NRF24L01_Init(void);//???
void NRF24L01_RX_Mode(void);//???????
void NRF24L01_TX_Mode(void);//???????
void NRF24L01_Write_Buf(char reg, char *pBuf, char chars);//????
void NRF24L01_Read_Buf(char reg, char *pBuf, char chars);//????		  
char NRF24L01_Read_Reg(char reg);			//????
void NRF24L01_Write_Reg(char reg, char value);//????
char NRF24L01_Check(void);//??24L01????
